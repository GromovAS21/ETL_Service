...
class MainDatabaseSettings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="MAIN_DB_", env_file=(".env",), env_file_encoding="utf-8", extra="ignore")
...
class AnalyticDatabaseSettings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="ANALYTIC_DB_", env_file=(".env",), env_file_encoding="utf-8", extra="ignore")
